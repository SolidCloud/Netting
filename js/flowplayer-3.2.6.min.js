        ...
        if (o) {
            ...
            if (q && r && flashembed.isSupported([6, 65])) {
                ...
                if (m.innerHTML.replace(/\s/g, "") !== "") {} else {
                    m.innerHTML = "<h2>Du måste ha Flash, version " + q + " eller senare för att köra denna fil</h2><h3>" + (k[0] > 0 ? "Din verision är " + k : "Du har inte flash installerat för att kolla på  filen offline ladda ner den : <a href='#' >här!</a>") + "</h3>" + (m.tagName == "A" ? "<p>Senaste verisionen av flash finns här </p>" : "<p>Ladda ner senaste verisionen från <a href='http://www.adobe.com/go/getflashplayer'>adobes hemsida</a></p>");
                    if (m.tagName == "A") {
                        m.onclick = function () {
